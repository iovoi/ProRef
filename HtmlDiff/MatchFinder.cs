    ...
    internal class MatchFinder
    {
        ...
        private void IndexNewWords()
        {
            ...
            for (int i = _startInNew; i < _endInNew; i++)
            {
                ...
                {
                    //Console.WriteLine("_options.BlockSize: " + _options.BlockSize);
                    //Console.WriteLine("Key: " + key);
                    //Console.WriteLine("_newWords[" + i + "]: " + _newWords[i]);
                    //Console.WriteLine("TryGetValue true, i: " + i.ToString());
                    indicies.Add(i);
                }
                else
                {
                    ...
                    //Console.WriteLine("Key: " + key);
                    //Console.WriteLine("_newWords[" + i + "]: " + _newWords[i]);
                    //Console.WriteLine("TryGetValue false, i: " + i.ToString());
            ...
            for (int indexInOld = _startInOld; indexInOld < _endInOld; indexInOld++)
            {
                ...
                foreach (int indexInNew in _wordIndices[index])
                {
                    ...
                    if (newMatchLength > bestMatchSize)
                    {
                        ...
                        //Console.WriteLine("indexInOld: " + indexInOld);
                        //Console.WriteLine("indexInNew: " + indexInNew);
                        //Console.WriteLine("bestMatchInOld: " + bestMatchInOld);
                        //Console.WriteLine("bestMatchInNew: " + bestMatchInNew);
                        //Console.WriteLine("_options.BlockSize: " + _options.BlockSize);
                        //Console.WriteLine("newMatchLength: " + newMatchLength);
